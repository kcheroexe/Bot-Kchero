...
//main.js
const smsWelcome = () => { return `*╭┈⊰* @subject *⊰┈ ✦*\n*┊Bot-Kchero te la da bienvenida!!*\n┊💖 @user\n┊📄*Lea la descripción del grupo y disfruté del bot.*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ @user\n┊ *Lárgate y no vuelvas, att Bot-Kchero !!* 🥵\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
const smsSpromote = () => { return '*@user OTRO ADMIN SE UNE AL GRUPO!!*'}
const smsSdemote = () => { return '*@user DEJO DESER ADMIN EN EL GRUPO!!*'}
...
//grupo-invocarkchexs.js
const smstagaa = () => { return `🥵 Bot-Kchero los invoca a todos, despierten! 🥵`}
